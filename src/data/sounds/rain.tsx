  ...
  sounds: [
    {
      ...
      id: 'light-rain',
      label: 'Light Rain',
      src: '/moodist/sounds/rain/light-rain.mp3',
    },
    {
      icon: <BsFillCloudRainHeavyFill />,
      id: 'heavy-rain',
      label: 'Heavy Rain',
      src: '/moodist/sounds/rain/heavy-rain.mp3',
    },
    {
      icon: <MdOutlineThunderstorm />,
      id: 'thunder',
      label: 'Thunder',
      src: '/moodist/sounds/rain/thunder.mp3',
    },
    {
      icon: <GiWindow />,
      id: 'rain-on-window',
      label: 'Rain on Window',
      src: '/moodist/sounds/rain/rain-on-window.mp3',
    },
    {
      icon: <BsUmbrellaFill />,
      id: 'rain-on-umbrella',
      label: 'Rain on Umbrella',
      src: '/moodist/sounds/rain/rain-on-umbrella.mp3',
    },
    {
      icon: <PiTentFill />,
      id: 'rain-on-tent',
      label: 'Rain on Tent',
      src: '/moodist/sounds/rain/rain-on-tent.mp3',
    },
    {
      icon: <FaLeaf />,
      id: 'rain-on-leaves',
      label: 'Rain on Leaves',
      src: '/moodist/sounds/rain/rain-on-leaves.mp3',
    },
  ],
  title: 'Rain',
};
